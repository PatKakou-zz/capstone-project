...
We will subset the different datasets to Toronto businesses.
...
```{r}
business <- readRDS("business_data.rds")
review <- readRDS("review_data.rds")
user <- readRDS("user_data.rds")
checkin <- readRDS("checkin_data.rds")
tip <- readRDS("tip_data.rds")
photo <- readRDS("photo_data.rds")
```
